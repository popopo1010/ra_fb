...
| ROOT | プロジェクトルート |
| REF_DIR | references/ |
| MASTER_DIR | references/法人マスタ/ |
| LONG_CALLS_DIR | references/long_calls/ |
| CA_DIR | references/法人面談議事録/ |
...
- [起動ガイド](起動ガイド.md)
- [法人マスタ README](../references/法人マスタ/README.md)
- [マスタ項目一覧](../references/法人マスタ/マスタ項目一覧.md)
